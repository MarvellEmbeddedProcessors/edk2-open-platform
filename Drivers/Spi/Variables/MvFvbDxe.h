...
#define INSTANCE_FROM_BLKIO_THIS(a)               CR(a, FVB_DEVICE, BlockIoProtocol, FVB_FLASH_SIGNATURE)
#define INSTANCE_FROM_DISKIO_THIS(a)              CR(a, FVB_DEVICE, DiskIoProtocol, FVB_FLASH_SIGNATURE)
