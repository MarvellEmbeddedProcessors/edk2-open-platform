...
//                    0x8100540000,       // Address Base (MMIO)
...
//            {
//                Memory32Fixed (ReadWrite,
//                    0x8800540000,       // Address Base (MMIO)
//                    0x00002000,         // Address Length
//                    )
//                Interrupt (ResourceConsumer, Level, ActiveHigh, Exclusive, ,, )
//                {
...
//            {
//                Memory32Fixed (ReadWrite,
//                    0x8100500000,       // Address Base (MMIO)
...
//            {
//                Memory32Fixed (ReadWrite,
//                    0x8100510000,       // Address Base (MMIO)
//                    0x00004000,         // Address Length
//                    )
//                Interrupt (ResourceConsumer, Level, ActiveHigh, Exclusive, ,, )
//                {
...
//            {
//                Memory32Fixed (ReadWrite, 0x8100000000 , 0x100000)
//                Memory32Fixed (ReadWrite, 0x8100129000 , 0xb000)
//            })
//            Name (_DSD, Package () {
//                ToUUID("daffd814-6eba-4d8c-8a91-bc9bbf4aa301"),
//                Package () {
...
//            Name (_CRS, ResourceTemplate ()
//            {
//                Memory32Fixed (ReadWrite, 0x8800000000 , 0x100000)
//                Memory32Fixed (ReadWrite, 0x8800129000 , 0xb000)
//            })
//            Name (_DSD, Package () {
//                ToUUID("daffd814-6eba-4d8c-8a91-bc9bbf4aa301"),
//                Package () {
