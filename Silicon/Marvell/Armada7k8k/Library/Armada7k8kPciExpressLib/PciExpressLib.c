  ...
  )
{
  ...
  //
  // Type 0 configuration cycles contain a b/d/f specifier, however
  // the endpoint is unaware of its own device number and responds to all
  // of them. The bus is responsible to ensure for assigning proper
  // device/function. Sadly, the Synopsys IP does not implement this,
  ...
  )
{
  ...
  if ((StartAddress & 1) != 0) {
    ...
    //
    MmioWrite8 ((UINTN)Buffer, PciExpressRead8 (StartAddress));
